...
class AboutSymbols < Neo::Koan
  ...
  #
  # Because each symbol is a unique value!! Whereas with strings,
  # you can compare their content and still get truthy results.
  # In other words, you can only find if a method exists by changing it
  # into a string first.
  ...
  # Each symbol you create will be stored in memory, also, they can't
  # be modified like strings can.
end
